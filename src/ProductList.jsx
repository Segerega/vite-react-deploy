...
function ProductList() {
    ...
    const itemsQuantity = cart.reduce((total, item) => total + item.quantity||0, 0)
    return (
        <div>
                ...
                <div style={styleObjUl}>
                    ...
                    <div><a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            ...
                            <span className="cart_quantity_count">{itemsQuantity}</span>
                        </h1>
                    </a></div>
                </div>
            </div>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <div className="product-proce">{plant.cost}</div>
